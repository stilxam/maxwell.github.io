...
<div align="center">
Eindhoven, NL | +41767996053 | maxwell.litsios.hilber@gmail.com | <a href="https://www.linkedin.com/in/maxwell-litsios-hilber">LinkedIn</a> | <a href="https://github.com/stilxam">GitHub</a>
</div>
...
### Education
#### Masters in Data Science and AI -- Eindhoven University of Technology
[2025-now]
...
<ul>
<li>Developing and benchmarking multiple deep reinforcement learning agents to navigate complex driving scenarios while adhering to safety constraints using a Budgeted Q-learning framework.</li>
<li>Implemented and trained a Bayesian Neural Network (BNN) with Pyro to model probabilistic distributions over Q-values, directly quantifying model uncertainty to enable risk-averse decision-making.</li>
<li>Engineered two additional methods for uncertainty estimation: Monte Carlo Dropout and Deep Ensembles, comparing their performance and computational trade-offs against the BNN.</li>
</ul>
</details>
...
#### Bachelors in Data Science -- Eindhoven University of Technology and University of Tilburg
[2021-2025]
##### Bachelor End Project: Neural Tangent Kernels To Measure Spectral Bias In INRs (9.5/10)
* Built an [open-source INR benchmarking codebase](https://github.com/stilxam/INR_BEP).
* Implemented 9 layer types and 2 positional encodings.
* Added suport to learn fourier transforms, derivatives and integral representations.
* Developed a NTK based trainability metric for INRs, outperforming the standard condition-number measure.

### Project Highlights

**MDM: Masked Diffusion Mamba for Generative Code Infilling (ongoing)**<br>
...
<ul>
    <li>Architected and training a novel, small-scale (~40M params) generative model for JAX code, to fill in masked regions within a sequence, encompassing the entire language modelling lifecycle from data sourcing to model evaluation.</li>
...
**EquiNTK: A Library for Neural Tangent Kernel (NTK) Dynamics in JAX**<br>
...
<ul>
    ...
    <li>Engineered a highly memory-efficient, JIT-compiled algorithm for exact NTK computation leveraging JAX primitives to process large datasets in batches, avoiding common out-of-memory errors.</li>
...
<em>Stack:</em> <b>JAX, Equinox, Optax</b>
<ul>
    <li>Implemented a library to enable mixed-precision training (<code>bfloat16</code>/<code>float16</code>) for Equinox models, reducing memory consumption and accelerating training on modern hardware.</li>
...
[2023-now] - **Programming for Data Science [JBI010] and for Applied Physics [31PAP] :** Mentored and instructed classes of 60 students in Python, created auxiliary course material, graded assignments, invigilated exams, and led course material recaps during instructor absences.

[2023-now] - **Project Supervisor [JBG030/JBG040] :** Supervised teams of 6–8 students in developing data-driven, explainable AI methods for predictive policing, ensuring projects met addressed stakeholder concerns, technical requirements and ethical considerations.


#### IBI Benchmarking | Data Scientist & Software Engineer
Eindhoven, NL [2023-2024]
